...
const BarSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-xs sm:text-xs font-bold text-[#B8860B] uppercase tracking-wider">Bar & Drinks</span>
      </motion.div>
      ...
      <motion.span
        className=" text-white/60 text-center text-sm sm:text-base md:text-lg mt-2 mb-6"
        initial={{ y: 20, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
        viewport={{ once: true }}
        transition={{ delay: 0.2 }}
          ...
          <ProductCard
            ...
            footer={
              <div className="flex justify-between items-center mx-5 mt-2 mb-4">
                <span className="text-xl text-[#B8860B] font-bold">R$ {product.price.toFixed(2)}</span>
