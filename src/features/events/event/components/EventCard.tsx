      ...
      <div className="flex flex-col p-6">
        ...
        <div className="flex items-center p-2">
          ...
          <span className="text-white/60 text-sm font-semibold">
            {formattedDate(event.starts_at).dayName}, {formattedDate(event.starts_at).dayNumber} de{" "}
            {formattedDate(event.starts_at).month} às {formattedDate(event.starts_at).time}
          </span>
        </div>
