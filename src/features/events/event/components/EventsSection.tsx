  ...
  return (
    <>
      ...
      >
        ...
        >
          <span className="text-xs font-bold text-[#B8860B] uppercase tracking-wider">Próximos Eventos</span>
        </motion.div>
        ...
        <motion.span
          ...
          transition={{ delay: 0.2 }}
        >
          Não perca os melhores eventos da semana. Garanta o seu ingresso agora mesmo!
        </motion.span>
                ...
                footer={
                  <div className="flex w-full items-center justify-between pt-4">
                    <div className="flex flex-col w-full">
                      ...
                      <span className="text-xl text-[#B8860B] font-bold">R$ {event.price.toFixed(2).replace(".", ",")}</span>
                    </div>
