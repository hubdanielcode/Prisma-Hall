...
const Schedule = () => {
  ...
  const filteredEvents = events.filter((event) => {
    ...
    return (
      dayNumber === selectedDay && month === selectedMonth.toLowerCase() && year === selectedYear
    );
  });
        ...
        {viewState === "Calendar" && (
          <>
            ...
            {todayEvents.length > 0 ? (
              ...
              <span className="text-white/40 text-sm">Nenhum evento neste dia.</span>
            )}
          </>
        )}
        ...
        {viewState === "List" && (
          <div className="flex flex-col w-full max-w-5xl gap-2">
            {monthEvents.length > 0 ? (
              ...
              <span className="text-white/40 text-sm text-center">Nenhum evento neste mês.</span>
            )}
          </div>
        )}
