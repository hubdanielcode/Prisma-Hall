...
const ReviewsSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-xs sm:text-xs font-bold text-[#B8860B] uppercase tracking-wider">Avaliações</span>
      </motion.div>
            ...
            return (
              ...
              >
                <div className="flex justify-center items-center mt-2">
                  ...
                  <span className="text-xl text-white font-bold">{badge.value}</span>
                </div>

                <span className="text-base text-white/60 font-semibold mt-2">{badge.label}</span>
              </div>
            );
          })}
        </div>
