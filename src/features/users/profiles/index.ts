...
export { ProfileEditModal } from "@/features/users/profiles/components/ProfileEditModal";
...
export {
  ProfileContext,
  ProfileProvider,
} from "@/features/users/profiles/context/ProfileContext";
...
export { ProfilePage } from "@/features/users/profiles/pages/ProfilePage";
