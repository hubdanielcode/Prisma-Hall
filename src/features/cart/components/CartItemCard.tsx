  ...
  return (
    <div className="flex items-center gap-3 px-3 py-3 bg-black/80 border border-[#B8860B60] rounded-lg w-[90%]">
      ...
      <div className="flex flex-col flex-1 mt-1">
        ...
        <span className="text-white/80 text-sm font-bold truncate">{item.type === "tickets" ? item.title : item.name}</span>
        ...
        {item.type === "drinks" && <span className="text-[#B8860B] text-xs font-semibold">{item.category}</span>}
