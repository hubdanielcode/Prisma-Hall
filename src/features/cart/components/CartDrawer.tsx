          ...
          >
            ...
            <div className="flex items-center justify-between w-full px-5 py-4 bg-black border-b border-[#B8860B60]">
              <div className="flex items-center gap-3 h-12">
                ...
                <span className="text-lg text-white font-semibold">Seu Carrinho</span>
              </div>
            ...
            {cartItems.length === 0 ? (
              <div className="flex flex-col items-center justify-center flex-1 gap-3">
                ...
                <p className="text-white/40 font-semibold text-base">Seu carrinho está vazio.</p>
              </div>
            ) : (
                ...
                {tickets.length > 0 && (
                  <>
                    <div className="flex items-center gap-2 w-[90%]">
                      ...
                      <span className="text-xs font-bold text-[#B8860B] uppercase tracking-wider">Ingressos</span>
                ...
                {drinks.length > 0 && (
                  <>
                    <div className="flex items-center gap-2 w-[90%]">
                      ...
                      <span className="text-xs font-bold text-[#B8860B] uppercase tracking-wider">Drinks</span>
            ...
            <div className="flex flex-col p-4 justify-start w-full bg-black border-t border-[#B8860B60]">
              ...
              <div className="flex justify-between w-full">
                ...
                {cartItems.length >= 1 && <span className="text-white text-sm font-semibold">R$ {totalItemPrice.toFixed(2).replace(".", ",")}</span>}
              </div>

              {/* - Taxa de serviço - */}

              <div className="flex justify-between w-full">
                <span className="text-white/60 text-sm font-semibold pb-4">Taxa de serviço</span>

                {cartItems.length >= 1 && <span className="text-white text-sm font-semibold">R$ {serviceFee.toFixed(2).replace(".", ",")}</span>}
              </div>
