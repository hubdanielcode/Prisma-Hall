...
const DeleteProductModal = ({ isOpen, onClose, product }: DeleteProductModalProps) => {
  /* - Puxando do context - */
        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-[#B8860B60]">
              <span className={`text-white font-semibold leading-none ${isPortraitMobile ? "text-lg" : "text-xl"}`}>Excluir Produto</span>
