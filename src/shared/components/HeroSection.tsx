...
const HeroSection = () => {
  ...
  const previousImage = () => {
    ...
    setCurrentSlide((prev) => (prev - 1 + rotatingImages.length) % rotatingImages.length);
  };
        ...
        >
          ...
          <div className="relative h-[85%] max-w-7xl mx-auto px-4 sm:px-6 md:px-8 mt-16 sm:mt-18 md:mt-20 flex items-center">
            <div className="max-w-2xl">
              ...
              >
                <span className="text-xs sm:text-xs font-bold text-[#B8860B] uppercase tracking-wider">Evento em Destaque</span>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2 text-white text-lg sm:text-xl md:text-xl font-semibold">
                  ...
                  <span>
                    {rotatingImages[currentSlide].date} às {rotatingImages[currentSlide].time}
                  </span>
                </div>
                ...
                >
                  ...
                  >
                    <div className="relative flex justify-center items-center gap-2">
                      ...
                      <span className="font-bold whitespace-nowrap">Comprar Ingresso</span>
                    </div>
                  </motion.button>
                ...
                >
                  <span className="text-xl sm:text-2xl md:text-2xl text-white font-semibold mb-1">A partir de </span>

                  <span className="text-2xl sm:text-3xl md:text-3xl font-bold text-[#B8860B]">R$ {rotatingImages[currentSlide].price}</span>
                </motion.div>
              </motion.div>
            </div>
          </div>
